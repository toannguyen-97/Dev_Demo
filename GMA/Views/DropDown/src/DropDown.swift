...
public final class DropDown: UIView {
	...
	*/
	...
	//MARK: Constraints
	fileprivate var ddHeightConstraint: NSLayoutConstraint!
	fileprivate var ddWidthConstraint: NSLayoutConstraint!
...
private extension DropDown {
	...
	func setupUI() {
        ...
        tableView.layer.borderColor = Colors.navigationBarButtonItemTitle.cgColor
...
extension DropDown {
	...
	public override func updateConstraints() {
		...
		ddWidthConstraint.constant = layout.width
		ddHeightConstraint.constant = layout.visibleHeight
	...
	fileprivate func setupConstraints() {
		...
		ddWidthConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .width,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(ddWidthConstraint)

		ddHeightConstraint = NSLayoutConstraint(
			item: tableViewContainer,
			attribute: .height,
			relatedBy: .equal,
			toItem: nil,
			...
			multiplier: 1,
			constant: 0)
		tableViewContainer.addConstraint(ddHeightConstraint)
