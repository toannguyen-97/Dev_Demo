...
final class KoyomiCell: UICollectionViewCell {
    ...
    var idetifierAccessibility: String? {
        didSet {
            if let iden = idetifierAccessibility {
                contentLabel.accessibilityIdentifier = iden
            }
        }
    }
    ...
    func configureAppearanse(of style: CellStyle, withColor color: UIColor, backgroundColor: UIColor, isSelected: Bool) {
        ...
        case .standard:
            ...
            self.layer.cornerRadius = isSelected ? 12.0 : 0.0
